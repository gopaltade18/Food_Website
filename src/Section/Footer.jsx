    ...
    <>
      <footer className='flex justify-center items-center px-10 lg:px-20 py-10 lg:py-12 flex-col gap-6 bg-slate-800 w-full'>
        <div id='social-icons' className='flex flex-row justify-start items-start gap-6 mt-3'>
          <div id='icons-box' className='bg-orange-500 p-2 rounded-full hover:bg-green-500 cursor-pointer'>
          ...
          <div id='icons-box' className='bg-orange-500 p-2 rounded-full hover:bg-green-500 cursor-pointer'>
            <img src={yt} alt='yt icon' width={28} height={28} />
          </div>
          <div id='icons-box' className='bg-orange-500 p-2 rounded-full hover:bg-green-500 cursor-pointer'>
            <img src={twitter} alt='twiiter icon' width={28} height={28} />
          </div>
        </div>
      ...
      <div className='w-full bg-black p-4 flex flex-col justify-center items-center text-white font-semibold'>
        <h1 className='text-center '>Copyright 2024, Designed & Developed by Flavor Fusion ,ALL Rights Reserved</h1>
        <div id='icons-box' className='bg-green-500 p-2 rounded-full hover:bg-orange-500 cursor-pointer fixed bottom-12 right-6'>
