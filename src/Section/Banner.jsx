  ...
  return (
    <section className='w-full bg-black h-fit flex justify-between items-center text-white px-10 lg:px-40 py-20 bg-cover bg-center' style={{ backgroundImage: `url(${banner1} )` }}>
      ...
      <div className='flex flex-col justify-center items-start gap-8 w-full'>
        ...
        <h1 data-aos='slide-up' data-aos-dealy='300' className='lg:text-6xl text-5xl font-semibold'>Keep up to date with us</h1>
        <p data-aos='slide-up' data-aos-dealy='400' className='text-xl lg:text-2xl font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        <div data-aos='slide-right' data-aos-dealy='600' id='form' className='flex flex-col lg:flex-row justify-start items-start w-full gap-6 mt-3'>
